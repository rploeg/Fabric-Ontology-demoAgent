...
This tool uses the [Unofficial Fabric Ontology SDK](https://github.com/falloutxAY/Unofficial-Fabric-Ontology-SDK) (v0.4.0) for ontology operations including validation, entity/relationship building, data bindings, and resilience patterns.
