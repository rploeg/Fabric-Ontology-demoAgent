...
This project provides everything you need to create and deploy Microsoft Fabric Ontology demos—automated tooling (powered by the [Unofficial Fabric Ontology SDK](https://github.com/falloutxAY/Unofficial-Fabric-Ontology-SDK)), AI agent specifications, and complete demo packages.
